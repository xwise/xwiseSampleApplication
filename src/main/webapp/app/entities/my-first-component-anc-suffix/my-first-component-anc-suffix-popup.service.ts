...
@Injectable()
export class MyFirstComponentAncSuffixPopupService {
            ...
            if (id) {
                this.myFirstComponentService.find(id)
                    .subscribe((myFirstComponentResponse: HttpResponse<MyFirstComponentAncSuffix>) => {
                        const myFirstComponent: MyFirstComponentAncSuffix = myFirstComponentResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.myFirstComponentModalRef(component, new MyFirstComponentAncSuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    myFirstComponentModalRef(component: Component, myFirstComponent: MyFirstComponentAncSuffix): NgbModalRef {
