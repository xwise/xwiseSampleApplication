...
public class BaselineResource {
    ...
    public BaselineResource(BaselineService baselineService) {
    ...
    @Timed
    public ResponseEntity<List<BaselineDTO>> getAllBaselines(Pageable pageable) {
        log.debug("REST request to get a page of Baselines");
        Page<BaselineDTO> page = baselineService.findAll(pageable);
