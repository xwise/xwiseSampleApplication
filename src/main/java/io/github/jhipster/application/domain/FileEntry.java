...
public class FileEntry implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "file_entry_baseline",
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "file_entry_upload_version",
               joinColumns = @JoinColumn(name="file_entries_id", referencedColumnName="id"),
               inverseJoinColumns = @JoinColumn(name="upload_versions_id", referencedColumnName="id"))
