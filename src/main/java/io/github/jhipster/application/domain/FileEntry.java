...
public class FileEntry implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Baseline> fileGroups = new HashSet<>();
    ...
    public Set<Baseline> getFileGroups() {
        return fileGroups;
    }

    public FileEntry fileGroups(Set<Baseline> baselines) {
        this.fileGroups = baselines;
        return this;
    }

    public FileEntry addFileGroup(Baseline baseline) {
        this.fileGroups.add(baseline);
        baseline.getFileGroups().add(this);
        return this;
    }

    public FileEntry removeFileGroup(Baseline baseline) {
        this.fileGroups.remove(baseline);
        baseline.getFileGroups().remove(this);
        return this;
    }

    public void setFileGroups(Set<Baseline> baselines) {
        this.fileGroups = baselines;
    }
