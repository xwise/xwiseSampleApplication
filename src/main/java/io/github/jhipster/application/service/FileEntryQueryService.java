...
public class FileEntryQueryService extends QueryService<FileEntry> {
    ...
    private Specifications<FileEntry> createSpecification(FileEntryCriteria criteria) {
        ...
        if (criteria != null) {
            ...
            if (criteria.getEntryName() != null) {
                specification = specification.and(buildStringSpecification(criteria.getEntryName(), FileEntry_.entryName));
            }
            if (criteria.getBaselineEntryVersionId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getBaselineEntryVersionId(), FileEntry_.baselineEntryVersions, BaselineEntryVersion_.id));
            }
