    ...
    private Specifications<FileEntry> createSpecification(FileEntryCriteria criteria) {
        ...
        if (criteria != null) {
            ...
            if (criteria.getUploadVersionId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getUploadVersionId(), FileEntry_.uploadVersions, UploadVersion_.id));
            }
            if (criteria.getBaselineId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getBaselineId(), FileEntry_.baseline, Baseline_.id));
            }
        }
