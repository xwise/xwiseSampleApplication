    ...
    private Specifications<UploadVersion> createSpecification(UploadVersionCriteria criteria) {
        ...
        if (criteria != null) {
            ...
            if (criteria.getUploadStatus() != null) {
                specification = specification.and(buildSpecification(criteria.getUploadStatus(), UploadVersion_.uploadStatus));
            }
            if (criteria.getFileEntryId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getFileEntryId(), UploadVersion_.fileEntries, FileEntry_.id));
            }
        }
