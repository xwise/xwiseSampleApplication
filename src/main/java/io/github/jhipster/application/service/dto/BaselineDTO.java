...
public class BaselineDTO implements Serializable {
    ...
    private Set<BaselineEntryDTO> baselines = new HashSet<>();
    ...
    public Set<BaselineEntryDTO> getBaselines() {
        return baselines;
    }

    public void setBaselines(Set<BaselineEntryDTO> baselineEntries) {
