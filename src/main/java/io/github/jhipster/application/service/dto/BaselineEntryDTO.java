...
public class BaselineEntryDTO implements Serializable {
    ...
    private Set<BaselineEntryVersionDTO> baselineEntries = new HashSet<>();
    ...
    public Set<BaselineEntryVersionDTO> getBaselineEntries() {
        return baselineEntries;
    }

    public void setBaselineEntries(Set<BaselineEntryVersionDTO> baselineEntryVersions) {
