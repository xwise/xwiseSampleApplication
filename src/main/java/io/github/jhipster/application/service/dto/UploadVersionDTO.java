...
public class UploadVersionDTO implements Serializable {
    ...
    private String fileEntryFileName;
    ...
    public String getFileEntryFileName() {
        return fileEntryFileName;
    }

    public void setFileEntryFileName(String fileEntryFileName) {
        this.fileEntryFileName = fileEntryFileName;
    }
