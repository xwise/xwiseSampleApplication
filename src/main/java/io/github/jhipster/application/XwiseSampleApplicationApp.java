...
public class XwiseSampleApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(XwiseSampleApplicationApp.class);

    private final Environment env;

    public XwiseSampleApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes xwiseSampleApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(XwiseSampleApplicationApp.class);
