...
import { MyFirstComponentAncSuffixDialogComponent } from '../../../../../../main/webapp/app/entities/my-first-component-anc-suffix/my-first-component-anc-suffix-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('MyFirstComponentAncSuffix Management Dialog Component', () => {
        let comp: MyFirstComponentAncSuffixDialogComponent;
        let fixture: ComponentFixture<MyFirstComponentAncSuffixDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [MyFirstComponentAncSuffixDialogComponent],
                providers: [
                    MyFirstComponentAncSuffixService
                ]
            })
            .overrideTemplate(MyFirstComponentAncSuffixDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(MyFirstComponentAncSuffixDialogComponent);
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new MyFirstComponentAncSuffix(123);
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new MyFirstComponentAncSuffix();
