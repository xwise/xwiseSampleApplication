...
describe('Service Tests', () => {
    ...
    describe('UploadVersionAncSuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UploadVersionAncSuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/upload-versions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UploadVersionAncSuffix', () => {
