...
describe('Service Tests', () => {
    ...
    describe('BaselineEntryAncSuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BaselineEntryAncSuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/baseline-entries';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BaselineEntryAncSuffix', () => {
