...
describe('Service Tests', () => {
    ...
    describe('BaselineEntryVersionAncSuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BaselineEntryVersionAncSuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/baseline-entry-versions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BaselineEntryVersionAncSuffix', () => {
