...
public class UploadVersionResourceIntTest {
    ...
    public void createUploadVersion() throws Exception {
        ...
        assertThat(testUploadVersion.getUploadStatus()).isEqualTo(DEFAULT_UPLOAD_STATUS);
    }
    ...
    @Test
    @Transactional
    public void getAllUploadVersionsByUploadStatusIsEqualToSomething() throws Exception {
        // Initialize the database
        uploadVersionRepository.saveAndFlush(uploadVersion);

        // Get all the uploadVersionList where uploadStatus equals to DEFAULT_UPLOAD_STATUS
        defaultUploadVersionShouldBeFound("uploadStatus.equals=" + DEFAULT_UPLOAD_STATUS);

        // Get all the uploadVersionList where uploadStatus equals to UPDATED_UPLOAD_STATUS
        defaultUploadVersionShouldNotBeFound("uploadStatus.equals=" + UPDATED_UPLOAD_STATUS);
    }

    @Test
    @Transactional
    public void getAllUploadVersionsByUploadStatusIsInShouldWork() throws Exception {
        // Initialize the database
        uploadVersionRepository.saveAndFlush(uploadVersion);

        // Get all the uploadVersionList where uploadStatus in DEFAULT_UPLOAD_STATUS or UPDATED_UPLOAD_STATUS
        defaultUploadVersionShouldBeFound("uploadStatus.in=" + DEFAULT_UPLOAD_STATUS + "," + UPDATED_UPLOAD_STATUS);

        // Get all the uploadVersionList where uploadStatus equals to UPDATED_UPLOAD_STATUS
        defaultUploadVersionShouldNotBeFound("uploadStatus.in=" + UPDATED_UPLOAD_STATUS);
    }

    @Test
    @Transactional
    public void getAllUploadVersionsByUploadStatusIsNullOrNotNull() throws Exception {
        // Initialize the database
        uploadVersionRepository.saveAndFlush(uploadVersion);

        // Get all the uploadVersionList where uploadStatus is not null
        defaultUploadVersionShouldBeFound("uploadStatus.specified=true");

        // Get all the uploadVersionList where uploadStatus is null
        defaultUploadVersionShouldNotBeFound("uploadStatus.specified=false");
    }
    ...
    public void getAllUploadVersionsByFileEntryIsEqualToSomething() throws Exception {
        ...
        em.flush();
        uploadVersion.addFileEntry(fileEntry);
        uploadVersionRepository.saveAndFlush(uploadVersion);
    ...
    public void updateUploadVersion() throws Exception {
        ...
        assertThat(testUploadVersion.getUploadStatus()).isEqualTo(UPDATED_UPLOAD_STATUS);
    }
